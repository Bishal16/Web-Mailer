...
//<--------------------------------------------------------------------------------modified sql for serching
$sql= "SELECT * from inbox where r_email='$current_user_mail' and ( s_email like '%$searched%' or title like '%$searched%' or datee like '%$searched%')";
//------------------------------------------------------------------------------->
